...
- **Dev Server URL**: `http://127.0.0.1:5214`
...
4. The dev server is accessible at `http://127.0.0.1:5214`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/ad73ec70-2bc5-4d1f-8e95-d7d1b5a2b755/preview`
